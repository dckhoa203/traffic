                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a  href="{{route('districts.edit', $item->district_id)}}" data-toggle="toolytip" data-placement="top" title="Chỉnh sửa">&nbsp;&nbsp;&nbsp;<i class="fa fa-pencil text-inverse m-r-10 fa-lg"></i></a>
                                                        @csrf
